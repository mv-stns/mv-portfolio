  ...
  return (
    <li>
      ...
      >
        {children}
        {isActive && (
          <span className="absolute h-px inset-x-1 -bottom-px bg-gradient-to-r from-orange-500/0 via-orange-500/40 to-orange-500/0 dark:from-orange-400/0 dark:via-orange-400/40 dark:to-orange-400/0" />
        )}
      </Link>
    </li>
  )
...
function DesktopNavigation(props) {
  return (
    <nav {...props}>
      <ul className="flex w-full px-3 text-sm font-medium rounded-full shadow-lg bg-white/90 text-zinc-800 shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
      ...
      >
        {isHomePage && (
          <>
            ...
            />
            <Container
              className="fixed order-last pt-3 -mb-3"
            >
          ...
          <Container>
            <div className="relative flex gap-4">
              ...
              <div className="flex justify-end flex-1 md:justify-center">
                ...
                <DesktopNavigation className="hidden pointer-events-auto md:block md:w-full" />
              </div>
